...
function truncateAddress(address: string | any[]) {
...
const Minting = () => {
    ...
    const editionDrop = useEditionDrop(
        "0xE36eC173D88bf4111f738BC93062F4640a5817a1"
    );
    ...
    const viewOpenSea = () => {
        const url = "https://testnets.opensea.io/assets/mumbai/0xE36eC173D88bf4111f738BC93062F4640a5817a1/0";
    ...
    if (hasClaimedNFT) {
        return (
            <div>
                <h2>
                    ☠️ Congratulations! ☠️ <br />
                    Minted Neu Vibez O.G.PASS NFT!
                </h2>
                        ...
                        <>
                            ...
                            {completed ? (
                                ...
                                <FilledButton disabled={inProgress} onClick={mint}>
                                    {inProgress ? (
                                        <ReactLoading type='bubbles' color='#000' height={32} />
                                    ) : (
                                        "Mint"
                                    )}
                                </FilledButton>
